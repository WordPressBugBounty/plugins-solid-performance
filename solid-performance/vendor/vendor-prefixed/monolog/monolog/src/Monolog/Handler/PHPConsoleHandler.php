 ...
 *
 *      $logger = new \SolidWP\Performance\Monolog\Logger('all', array(new \SolidWP\Performance\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['SolidWP\\Performance\\Monolog\\'], // array Hide calls of classes started with...
