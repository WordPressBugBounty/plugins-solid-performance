...
namespace SolidWP\Performance\StellarWP\Telemetry\Exit_Interview;
...
use SolidWP\Performance\StellarWP\Telemetry\Config;
use SolidWP\Performance\StellarWP\Telemetry\Contracts\Template_Interface;
...
class Template implements Template_Interface {
	 ...
	 * @since 1.0.0
	 *
	 * @var \SolidWP\Performance\StellarWP\ContainerContract\ContainerInterface
	 */
	protected $container;
	 ...
	 * @since 1.0.0
	 *
	 * @param \SolidWP\Performance\StellarWP\ContainerContract\ContainerInterface $container The container.
	 */
