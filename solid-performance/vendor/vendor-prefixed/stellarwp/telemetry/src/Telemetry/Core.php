...
namespace SolidWP\Performance\StellarWP\Telemetry;

use SolidWP\Performance\StellarWP\ContainerContract\ContainerInterface;
use SolidWP\Performance\StellarWP\Telemetry\Admin\Admin_Subscriber;
use SolidWP\Performance\StellarWP\Telemetry\Admin\Resources;
use SolidWP\Performance\StellarWP\Telemetry\Contracts\Data_Provider;
use SolidWP\Performance\StellarWP\Telemetry\Data_Providers\Debug_Data;
use SolidWP\Performance\StellarWP\Telemetry\Events\Event_Subscriber;
use SolidWP\Performance\StellarWP\Telemetry\Exit_Interview\Exit_Interview_Subscriber;
use SolidWP\Performance\StellarWP\Telemetry\Exit_Interview\Template;
use SolidWP\Performance\StellarWP\Telemetry\Last_Send\Last_Send;
use SolidWP\Performance\StellarWP\Telemetry\Last_Send\Last_Send_Subscriber;
use SolidWP\Performance\StellarWP\Telemetry\Opt_In\Opt_In_Subscriber;
use SolidWP\Performance\StellarWP\Telemetry\Opt_In\Opt_In_Template;
use SolidWP\Performance\StellarWP\Telemetry\Opt_In\Status;
use SolidWP\Performance\StellarWP\Telemetry\Telemetry\Telemetry;
use SolidWP\Performance\StellarWP\Telemetry\Telemetry\Telemetry_Subscriber;
...
class Core {
	 ...
	 * @since 1.0.0
	 *
	 * @return \SolidWP\Performance\StellarWP\ContainerContract\ContainerInterface
	 */
