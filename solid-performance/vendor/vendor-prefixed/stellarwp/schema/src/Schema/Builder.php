...
namespace SolidWP\Performance\StellarWP\Schema;

use SolidWP\Performance\StellarWP\Schema\Config;
use SolidWP\Performance\StellarWP\Schema\Fields;
use SolidWP\Performance\StellarWP\Schema\Fields\Contracts\Schema_Interface as Field_Schema_Interface;
use SolidWP\Performance\StellarWP\Schema\Tables;
use SolidWP\Performance\StellarWP\Schema\Tables\Contracts\Schema_Interface as Table_Schema_Interface;
use SolidWP\Performance\StellarWP\Schema\Tables\Filters\Group_FilterIterator;
use WP_CLI;
...
class Builder {
	 ...
	 * StellarWP\DB class.
	 *
	 * @var class-string<\SolidWP\Performance\StellarWP\DB\DB>
	 */
	protected $db;
	 ...
	 * Constructor.
	 *
	 * @param class-string<\SolidWP\Performance\StellarWP\DB\DB>|null $db StellarWP\DB class.
	 ...
	 * @since 1.0.0
	 *
	 * @throws \SolidWP\Performance\StellarWP\DB\Database\Exceptions\DatabaseQueryException If the query fails.
	 *
