...
namespace SolidWP\Performance\StellarWP\Schema\Tables\Contracts;
...
abstract class Table implements Schema_Interface {
	...
	/**
	 * @var class-string<\SolidWP\Performance\StellarWP\DB\DB> The db class.
	 */
	protected $db;
	 ...
	 * @since 1.0.0
	 *
	 * @param class-string<\SolidWP\Performance\StellarWP\DB\DB>|null $db StellarWP\DB object.
