...
use SolidWP\Performance\Psr\Http\Message\ResponseInterface;
...
use SolidWP\Performance\Symfony\Component\HttpClient\Response\StreamableInterface;
use SolidWP\Performance\Symfony\Component\HttpClient\Response\StreamWrapper;
...
use SolidWP\Performance\Symfony\Contracts\HttpClient\ResponseInterface as HttpClientResponseInterface;
use SolidWP\Performance\Symfony\Contracts\Service\ResetInterface;

if (!interface_exists(RequestFactoryInterface::class)) {
    throw new \LogicException('You cannot use the "SolidWP\Performance\Symfony\Component\HttpClient\Psr18Client" as the "psr/http-factory" package is not installed. Try running "composer require nyholm/psr7".');
}

if (!interface_exists(ClientInterface::class)) {
    throw new \LogicException('You cannot use the "SolidWP\Performance\Symfony\Component\HttpClient\Psr18Client" as the "psr/http-client" package is not installed. Try running "composer require psr/http-client".');
}
...
final class Psr18Client implements ClientInterface, RequestFactoryInterface, StreamFactoryInterface, UriFactoryInterface, ResetInterface
{
    ...
    public function __construct(?HttpClientInterface $client = null, ?ResponseFactoryInterface $responseFactory = null, ?StreamFactoryInterface $streamFactory = null)
    {
        ...
        if (!class_exists(Psr17Factory::class) && !class_exists(Psr17FactoryDiscovery::class)) {
            throw new \LogicException('You cannot use the "SolidWP\Performance\Symfony\Component\HttpClient\Psr18Client" as no PSR-17 factories have been provided. Try running "composer require nyholm/psr7".');
        }
