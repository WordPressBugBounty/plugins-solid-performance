...
class Debug {
	...
	public function get_debug_comment( Request $request, Compressible $compressor ): string {
		...
		return "
<!--
Kadence Performance page optimization. Learn more: https://solidwp.com/performance
...
Served from: $host @ $date_time by Kadence Performance
-->";
	}
	...
	public function get_generated_by_comment(): string {
		...
		return sprintf(
			'
<!-- Cached page generated by Kadence Performance on %s -->',
