...
<div class="notice-content">
	<div class="notice-title">
		<h2><?php echo esc_html__( 'Welcome to Kadence Performance!', 'solid-performance' ); ?></h2>
		<span class="notice-status">
			...
			<?php echo esc_html__( 'Kadence Performance activated', 'solid-performance' ); ?>
		</span>
	</div>
	<p><?php echo esc_html__( 'The page cache is enabled. Visit the Kadence Performance settings page to customize your configuration.', 'solid-performance' ); ?></p>
</div>
