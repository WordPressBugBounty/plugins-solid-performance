<?php
/**
 * Plugin Name: Kadence Performance Advanced Cache Drop-In
 * Plugin URI: https://kadencewp.com
 * Description: A Kadence Performance drop-in that enhances site performance by caching responses, reducing server load, and minimizing response times.
 * Version: {{swpsp-advanced-cache-version}}
 * Author: Kadence
...
if ( SWPSP_ADVANCED_CACHE ) {
	...
	spl_autoload_register(
		static function ( $path ): void {
			// Return if not loading a Kadence Performance class.
	...
	try {
		...
		swpsp_log( 'Kadence Performance - A critical error occurred: ' . $e->getMessage() );
	}
